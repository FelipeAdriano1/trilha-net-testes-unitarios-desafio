...
- IDE: **Visual Studio**
- Ferramenta de Testes Unitários: **xUnit**
...
## Resultados 🎯
O objetivo deste desafio é testar cada classe e cada método individualmente. Percebi o comportamento de cada método e seus resultados esperados. Pude ver na prática que testes unitários tem uma grande importância pois validam de forma rigorosa passo a passo do comportamento do programa.
